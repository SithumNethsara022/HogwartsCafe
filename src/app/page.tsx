             ...
             <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="aspect-square relative rounded-3xl overflow-hidden glass border-white/10 p-2 shadow-2xl group">
                  <div className="absolute inset-0 bg-secondary/10 group-hover:bg-secondary/20 transition-colors flex items-center justify-center">
                    <span className="text-primary/20 font-headline italic text-center px-10">Add Your Map Embed or Image Here</span>
                  </div>
      ...
      <footer className="py-16 border-t border-white/5 glass-dark text-center">
        <div className="max-w-7xl mx-auto px-4 space-y-8">
          ...
          <p className="text-[10px] text-muted-foreground/40 max-w-sm mx-auto uppercase tracking-tighter">
            Legal notice: No dragons were harmed in the making of this menu. All magic happens in our kitchen.
          </p>
        </div>
      </footer>
